...
auth_channel = environ.get('AUTH_CHANNEL', '-1002293560200 ') # give your force subscribe channel id here else leave it blank
...
PAYMENT_QR = environ.get('PAYMENT_QR', '8513991436@naviaxis') # payment code picture url.
