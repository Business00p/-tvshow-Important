...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '27372121').split()] # For Multiple Id Use One Space Between Each.
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'pubdbdhjd') # Support Chat Link Without https:// or @
